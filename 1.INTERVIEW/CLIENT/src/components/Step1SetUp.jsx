...
import { setInterviewData } from "../redux/userSlice.js";
import {
FaUserTie,
FaBriefcase,
FaFileUpload,
...
const handleStartInterview = async () => {
  ...
  try {
    const result =await axios.post(
      ...
      { role, experience, projects, skills, resumeText, mode },{ withCredentials: true })
      console.log("Questions generated:", result.data);
      if(userData){
        dispatch(setInterviewData({...userData,  credits: result.data.creditLeft}));
      }
      setLoading(false);
      onStart(result.data);
  }catch (error) {
  ...
  <motion.button
    ...
    className="mt-4 bg-gray-900 text-white px-5 py-3 rounded-lg hover:bg-gray-800 transition"
  >
