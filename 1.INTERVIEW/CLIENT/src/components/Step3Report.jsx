...
import autoTable from "jspdf-autotable"; // <--- Added missing import
import {
  ResponsiveContainer,
  AreaChart,
  Area,
...
function Step3Report({ report }) {
  ...
  if (finalScore >= 8) {
    ...
    shortTagline = "Practice communication and technical concepts.";
  }
  ...
  const handleDownloadPDF = () => {
    ...
    if (finalScore >= 8) {
      advice =
        "Excellent performance. Maintain confidence and structure while refining clarity and supporting answers with strong real-life examples.";
    } else if (finalScore >= 5) {
      advice =
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 sm:px-6 lg:px-10 py-8">
